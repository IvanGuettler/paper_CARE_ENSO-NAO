...
RCM=ncread(['./detrend_maskiran_subregion_',SEAStxt{SEAS},'_MOD_1_15.nc'],'pr');
lon=ncread('./detrend_maskiran_subregion_JFM_CRU.nc','lon');
lat=ncread('./detrend_maskiran_subregion_JFM_CRU.nc','lat');
...
filename=['EOF_',SEAStxt{SEAS},'_MODperMOD.nc'];
