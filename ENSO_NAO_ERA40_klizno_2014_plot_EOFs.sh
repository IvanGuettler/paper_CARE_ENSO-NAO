...
*--------------------------------------------------------------------------------------------------------
    ...
    'sdfopen    /home/guettler/bonus_disk/MODELS/ENSEMBLES/DIR_ANALIZA_ENSO_NAO/2014_pr/FILES_EOF/EOF_'SESItxt.SESI'.nc'
...
*     if (VAR=1); 'draw title ERA40 EOF'EOFS' 'SESItxt.SESI' \ 0.1 0.4 0.8 1.2 1.6'; endif
      if (VAR=1); 'draw title ERA40 EOF'EOFS' 'SESItxt.SESI ; endif
...
if [ ${VAR} == 1 ]; then
FILE=ERA40_${SESItxt[${SESI}]}_pr_EOF${EOFS}
fi
