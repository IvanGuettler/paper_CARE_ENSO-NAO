...
*--------------------------------------------------------------------------------------------------------
*DHMZ    'sdfopen ./2014_pr/pr_ERA40_TIMAVG_SM_'SESItxt.SESI'_SMS_2014_interp.nc'
...
say '------------------------------------------------------------------------->'FILE
      ...
      'fprintf.gs totable1 ERA40_domain_all_'SESItxt.SESI'.txt %g 1'
      'fprintf.gs totable2 ERA40_domain_SSS_'SESItxt.SESI'.txt %g 1'
      'fprintf.gs totable3 ERA40_domain_NNN_'SESItxt.SESI'.txt %g 1'
*------------------------------------------------------------
* Print plot 
*------------------------------------------------------------
