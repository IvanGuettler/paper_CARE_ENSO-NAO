...
*--------------------------------------------------------------------------------------------------------
if (VAR=1)
    'sdfopen ./DIR_ERA40/'VARtxt.VAR'_ERA40_SM_'SESItxt.SESI'_All'INDtxt.IND'plus_anomalyVS'MEANtxt.MEAN'_SMS.nc'
    'sdfopen ./DIR_ERA40/'VARtxt.VAR'_ERA40_SM_'SESItxt.SESI'_All'INDtxt.IND'minus_anomalyVS'MEANtxt2.MEAN'_SMS.nc'
     varic1='pr'
    offset1=0
    factor1=86400
endif
...
say '------------------------------------------------------------------------->'FILE
      ...
      if (FILE=1); 'draw title EU ERA40 'varTXT.VAR' 'SESItxt.SESI' 'INDtxt.IND'+ composite'; endif
      if (FILE=2); 'draw title EU ERA40 'varTXT.VAR' 'SESItxt.SESI' 'INDtxt.IND'- composite';   endif
FILE=FILE+1
endwhile
...
LONstart=-180; LONend=180;
LATstart= -90; LATend=90;
'set lon 'LONstart' 'LONend
'set lat 'LATstart' 'LATend
...
say '------------------------------------------------------------------------->'FILE
      ...
      if (FILE=1); 'draw title World ERA40 'varTXT.VAR' 'SESItxt.SESI' 'INDtxt.IND'+ composite'; endif
      if (FILE=2); 'draw title World ERA40 'varTXT.VAR' 'SESItxt.SESI' 'INDtxt.IND'- composite'; endif
FILE=FILE+1
endwhile
...
FILE=ERA40_${INDtxt[${IND}]}_${SESItxt[${SESI}]}_${VARtxt[${VAR}]}_vsMEAN${MEAN}
