...
say '------------------------------------------------------------------------->'FILE
      ...
      if (VAR=1); 'draw title ERA40-CRU pr (mm/day) 'SESItxt.SESI' 0.5x0.5 grid \ clevs 0.2 0.5 1 2 5; smoothed'; endif
...
if [ ${VAR} == 1 ]; then
FILE=ERA40_${SESItxt[${SESI}]}_pr_climatology_errors_vsCRU
fi
