...
for TIP in {1..36}                     ; do
   for SES in 12                       ; do
    ...
    INPUT2=./2016_pr/FILES_RCM/${VAR}_MOD_ENSAVG_TIMAVG_SM_${SEAStxt[${SES}]}_SMS_2014.nc #ENSEMBLE i TIME srednjak
...
#2016-08-30    INPUT1=${VAR}_MOD_*_SM_${SEAStxt[${SES}]}_TIP${TIP}_anomalySquared_SMS_2016.nc
     ...
     OUTPUT=${VAR}_MOD_ENSAVG_SM_${SEAStxt[${SES}]}_TIP${TIP}_spread2_SMS_2016.nc
