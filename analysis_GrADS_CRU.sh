...
*--------------------------------------------------------------------------------------------------------
if (VAR=1)
    'sdfopen ./DIR_CRU/'VARtxt.VAR'_CRU_SM_'SESItxt.SESI'_All'INDtxt.IND'plus_anomalyVS'MEANtxt.MEAN'_SMS.nc'
    'sdfopen ./DIR_CRU/'VARtxt.VAR'_CRU_SM_'SESItxt.SESI'_All'INDtxt.IND'minus_anomalyVS'MEANtxt2.MEAN'_SMS.nc'
     varic1='pre'
    offset1=0
    factor1=1
endif
...
say '------------------------------------------------------------------------->'FILE
      ...
      if (FILE=1); 'draw title EU CRU 'varTXT.VAR' 'SESItxt.SESI' 'INDtxt.IND'+ composite'; endif
      if (FILE=2); 'draw title EU CRU 'varTXT.VAR' 'SESItxt.SESI' 'INDtxt.IND'- composite';   endif
FILE=FILE+1
endwhile
...
say '------------------------------------------------------------------------->'FILE
      ...
      if (FILE=1); 'draw title World CRU 'varTXT.VAR' 'SESItxt.SESI' 'INDtxt.IND'+ composite'; endif
      if (FILE=2); 'draw title World CRU 'varTXT.VAR' 'SESItxt.SESI' 'INDtxt.IND'- composite'; endif
FILE=FILE+1
endwhile
...
FILE=CRU_${INDtxt[${IND}]}_${SESItxt[${SESI}]}_${VARtxt[${VAR}]}_vsMEAN${MEAN}
