...
while TIT<=6
FILE=TIT+6*(GGGG-1)
    'sdfopen /bonus_disk/MODELS/ENSEMBLES/DIR_ANALIZA_ENSO_NAO/2014_pr/FILES_CRU/pr_CRU_SM_'SESItxt.SESI'_TIP'FILE'_anomaly_SMS_2014.nc'
    TIT=TIT+1
endwhile
     varic1='pre'
    offset1=0
...
*     'draw title CRU pr (mm/day) 'SESItxt.SESI' 'TYPEtxt.TIT' composite \ clevs 0.2 0.5 1 2 5 7 9 11 13'
*     'draw title CRU pr (mm/day) 'SESItxt.SESI' 'TYPEtxt.TIT' composite \ clevs 0.2 0.5 1 2 5 7 9 11 13; smoothed'
      'draw title CRU pr (mm/day) 'SESItxt.SESI' 'TYPEtxt.TIT' composite'
TIT=TIT+1
endwhile
...
FILE=CRU_GROUP${GGG}_${SESItxt[${SESI}]}_pr_composite_smth9
