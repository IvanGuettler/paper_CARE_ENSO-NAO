...
*     if (VAR=1); 'draw title CRU EOF'EOFS' 'SESItxt.SESI' \ 0.1 0.4 0.8 1.2 1.6'; endif
      if (VAR=1); 'draw title CRU EOF'EOFS' 'SESItxt.SESI ; endif
...
if [ ${VAR} == 1 ]; then
FILE=CRU_${SESItxt[${SESI}]}_pr_EOF${EOFS}
fi
