...
%      legend([h1 h4 h2 h3],{'RCM(i)','RCM ENS','CRU', 'ERA40'},'Fontsize',futa)
       leg=legend('RCM min/max','RCM ENS','CRU', 'ERA40'); set(leg,'Fontsize',futa,'Location','southwest'); legend boxoff; set(leg,'Linewidth',3);
