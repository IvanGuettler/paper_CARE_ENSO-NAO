...
*--------------------------------------------------------------------------------------------------------
*---DHMZ stolno
    'sdfopen /home/guettler/bonus_disk/MODELS/ENSEMBLES/DIR_ANALIZA_ENSO_NAO/2016_pr/FILES_CRU/pr_CRU_TIMSTD_SM_'SESItxt.SESI'_SMS_2016.nc'
*---DHMZ
     varic1='pre'
    offset1=0
    factor1=1
...
*      'draw title CRU pr (mm/day) 'SESItxt.SESI' std. dev. \ clevs 0.5 1 2 3 4 5 6 9 12'
       'draw title CRU pr (mm/day) 'SESItxt.SESI' std. dev. \ clevs 1 2 3 4 5 6 7 8 9'
...
FILE=CRU_${SESItxt[${SESI}]}_pr_sdtDev
